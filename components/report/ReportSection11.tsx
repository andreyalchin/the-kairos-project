      ...
      <div className="space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100">
          <div className="flex justify-between items-center mb-2">
            ...
            <p className="text-indigo font-bold text-sm">{(revisionRate * 100).toFixed(0)}%</p>
          </div>
        ...
        <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100">
          <div className="flex justify-between items-center mb-2">
            ...
            <p className="text-indigo font-bold text-sm">{consistencyScore.toFixed(0)} / 100</p>
          </div>
        ...
        <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100">
          <div className="flex justify-between items-center mb-2">
            ...
            <p className="text-indigo font-bold text-sm">{(avgResponseMs / 1000).toFixed(1)}s per question</p>
          </div>
