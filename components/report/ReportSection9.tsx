...
export function ReportSection9({ result, archetype }: { result: AssessmentResult; archetype: ArchetypeDefinition }) {
  ...
  return (
    <section className="space-y-8 py-8">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-teal-50 to-indigo-50 border border-teal-100">
      ...
      {isEntrepreneurial && (
        <div className="p-4 rounded-xl bg-indigo-50 border border-indigo-100 flex gap-3 items-start">
